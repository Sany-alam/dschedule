...
if(isset($_POST['deleteLimitSchedule'])){
    ...
    $day = $_POST['day'];
    $limit = $_POST['limit'];
    $sql = "DELETE FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day' AND `patient_limit` = '$limit'";
...
if(isset($_POST['changeLimitSchedule'])){
    ...
    $day = $_POST['day'];
    $limit = $_POST['limit'];
    $sql = "UPDATE `tbl_day_limits` SET `patient_limit`='$limit' WHERE `doctor_id` = '$doctor_id' AND `day` = '$day'";
    $res = mysqli_query($conn,$sql);
}
...
if(isset($_POST['changeLimitModal'])){
    $doctor_id = $_POST['doctor_id'];
    $day = $_POST['day'];
    $sql = "SELECT * FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day'";
    $res = mysqli_query($conn,$sql);
...
if(isset($_POST['setLimitInShcedule'])){
    ...
    $day = $_POST['day'];
    $limit = $_POST['limit'];
    $sql = "INSERT INTO `tbl_day_limits`(`doctor_id`,`day`,`patient_limit`) VALUES ('$doctor_id','$day','$limit')";
    $res = mysqli_query($conn,$sql);
}
...
if (isset($_POST['addSchedule'])) {
    ...
    $sql = "INSERT INTO `tbl_schedule`(`doctor_id`, `day`, `start_time`, `end_time`, `note`, `status`) VALUES ('$doctor_id','$day','$start_time','$end_time','$note','$status')";
    $res = mysqli_query($conn,$sql);
}
...
if (isset($_POST['updateSchedule'])) {
    ...
    $sql = "UPDATE `tbl_schedule` SET `day`='$day',`start_time`='$start_time',`end_time`='$end_time',`note`='$note',`status`='$status' WHERE `id` = '$id'";
    $res = mysqli_query($conn,$sql);
}

if (isset($_POST['showingSchedule'])) {
    $doctor_id = $_SESSION['doctor']['id'];
    $sql_sat = "SELECT * FROM `tbl_schedule` WHERE `doctor_id` = '$doctor_id' AND `day` = 'sat'";
    ...
    $day = "sat";
    $sql_limit = "SELECT * FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day'";
    ...
    $sql_sun = "SELECT * FROM `tbl_schedule` WHERE `doctor_id` = '$doctor_id' AND `day` = 'sun'";
    ...
    $day_sun = "sun";
    $sql_limit_sun = "SELECT * FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day_sun'";
    ...
    $sql_mon = "SELECT * FROM `tbl_schedule` WHERE `doctor_id` = '$doctor_id' AND `day` = 'mon'";
    ...
    $day_mon = "mon";
    $sql_limit_mon = "SELECT * FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day_mon'";
    ...
    $sql_tue = "SELECT * FROM `tbl_schedule` WHERE `doctor_id` = '$doctor_id' AND `day` = 'tue'";
    ...
    $day_tue = "tue";
    $sql_limit_tue = "SELECT * FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day_tue'";
    ...
    $sql_wed = "SELECT * FROM `tbl_schedule` WHERE `doctor_id` = '$doctor_id' AND `day` = 'wed'";
    ...
    $day_wed = "wed";
    $sql_limit_wed = "SELECT * FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day_wed'";
    ...
    $sql_thu = "SELECT * FROM `tbl_schedule` WHERE `doctor_id` = '$doctor_id' AND `day` = 'thu'";
    ...
    $day_thu = "thu";
    $sql_limit_thu = "SELECT * FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day_thu'";
    ...
    $sql_fri = "SELECT * FROM `tbl_schedule` WHERE `doctor_id` = '$doctor_id' AND `day` = 'fri'";
    ...
    $day_fri = "fri";
    $sql_fri_limit = "SELECT * FROM `tbl_day_limits` WHERE `doctor_id` = '$doctor_id' AND `day` = '$day_fri'";
