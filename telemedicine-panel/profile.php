                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-row my-2">
                                    ...
                                    <div class="col-6 form-group my-2">
                                        <label for="prescriptio-header">Prescription header</label>
                                        <input id="prescriptio-header" type="text" class="form-control" placeholder="Prescriptio header">
                                    </div>
                                </div>
...
$(function() {
    ...
    $("#save-info").click(function() {
        ...
        data.append('prescriptio_header',$("#prescriptio-header").val());
...
function showing() {
    ...
    $.ajax({
        ...
        success:function(data,status){
            ...
            $("#phone").val(a.msisdn);
            $("#email").val(a.email);
            $("#prescriptio-header").val(a.pres_header);
        },
    });
}
</script>
